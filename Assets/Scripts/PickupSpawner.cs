...
public class PickupSpawner : MonoBehaviour
{
   ...
   const int MaxNumPickups= 20; //benim
	...
	const int MaxSpawnTries = 20;//benim
    ...
    public PickupSpawnedEvent pickupSpawnedEvent= new PickupSpawnedEvent();
   // UnityAction<PickupSpawnedEvent> onPickupSpawned;
